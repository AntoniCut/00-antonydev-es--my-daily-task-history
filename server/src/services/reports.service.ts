 ...
 * -----  `sumMinutes()`  -----
 * ----------------------------
 * - Suma minutos y cantidad de registros dentro de un rango.
 */
const sumMinutes = (
    entries: TimeEntry[],
    from?: string,
...
export class ReportsService {
     ...
     * -----  `summary()`  -----
     * -------------------------
     * - Resume el tiempo invertido por tarea y subtarea en un rango.
     */
     ...
     * -----  `days()`  -----
     * ----------------------
     * - Devuelve los totales agregados por dia para un rango.
     */
    ...
    async stats(date = todayKey()): Promise<StatsSummary> {
         ...
         * -----  `total()`  -----
         * -----------------------
         * - Suma los minutos de los registros dentro del rango indicado.
         */
     ...
     * -----  `dayTotals()`  -----
     * ---------------------------
     * - Agrupa el tiempo por fecha para el rango recibido.
     */
    private dayTotals(tasks: Task[], from?: string, to?: string): DayTotal[] {
        ...
        return [...totals.entries()]
            .map(([day, minutes]) => ({ date: day, minutes }))
